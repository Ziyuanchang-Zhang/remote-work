        ...
        for file_path in files:
            ...
            try:
                ...
                try:
                    ...
                    logger.warning(f"Encoding detection failed for {file_path}, using utf-8: {e}")
...
def prepare_data_pipeline(documents:List[Document], is_ollama_embedder: bool = None,file_name:str = None):
    """
    ...
    hybrid_splitter=MultiLanguageTextSplitter(text_splitter,file_path=file_name)
    split_docs=hybrid_splitter.split_documents(documents)
    ...
    return  split_docs,data_transformer
...
def transform_documents_and_save_to_db(
    ...
    Args:
        ...
        is_ollama_embedder (bool, optional): Whether to use Ollama for embedding.
                                           If None, will be determined from configuration.
    """
    file_name_with_ext=os.path.basename(db_path)
    file_name=os.path.splitext(file_name_with_ext)[0]
    # Get the data transformer
    split_docs,data_transformer = prepare_data_pipeline(documents,is_ollama_embedder,file_name=file_name)
